...
MAX_CRAWL_RECORDS = 50  # How many crawl records to keep in memory
MAX_THROTTLE_RECORDS = 50  # How many throttle records to keep in
ALLOWED_REQUESTS_PER_MINUTE = (
    100  # How many requests an IP can make per THROTTLE_RESET_DURATION before being throttled.
)
THROTTLE_RESET_DURATION = 60 if not DEBUG else 15  # In seconds, how long it takes to reset ALLOWED_REQUESTS_PER_MINUTE.
STALE_IP_DURATION = (
